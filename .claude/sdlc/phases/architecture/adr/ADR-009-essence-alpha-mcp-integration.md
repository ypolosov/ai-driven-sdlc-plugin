...
## Deprecation note (2026-05-05)

Решение Deprecated в Wave 5; superseded by ADR-011.
SQLite single-writer не поддерживает team-сценарии mid+.
Векторный поиск pgvector нужен для RAG-домена aggregator'а.
...
Разовая миграция dogfooding-target — `scripts/migrate-essence-to-state-rag.sh` (PR-E2d).
